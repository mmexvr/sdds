...
1. Install `components` and `scania-theme` package from NPM in your project folder
   ...
   npm i @s-ds/theme-light
   ```

2. Import `defineCustomElements` and `add-theme` from `@s-ds/components`

3. Import `theme` from `@s-ds/theme-light` and use `c-theme` component in the template
